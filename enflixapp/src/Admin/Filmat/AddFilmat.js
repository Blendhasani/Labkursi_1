                             ...
                             >
                                ...
                                <Form onSubmit={this.submitFilmat}>
                                    ...
                                    <Form.Group controlId="AktoriID">
                                       <Form.Label>Aktori</Form.Label>
                                       <Form.Control as="select">
                                          {this.state.akto.map(akt=>
                                          <option key={akt.AktortiFId} value={akt.AktortiFId}>{akt.Emri}</option>)}
                                       </Form.Control>
                                    </Form.Group>
                                    ...
                                    <Form.Group controlId="ProducentiID">
                                       ...
                                       <Form.Control as="select">
                                          ...
                                          <option key={pro.ProducentiID} value={pro.ProducentiID}>{pro.Emri}</option>)}
                                       </Form.Control>
                                    </Form.Group>
                                    <Form.Group controlId="RegjisoriID">
                                       ...
                                       <Form.Control as="select">
                                          ...
                                          <option key={reg.RegjisoriFID} value={reg.RegjisoriFID}>{reg.Emri}</option>)}
                                       </Form.Control>
                                    </Form.Group>
